...
// it("Recreate auction by buyer", async () => {
//   const serialNum = new anchor.BN(1);
  
//   // Get original auction PDA using creator's pubkey
//   const [originalAuction] = PublicKey.findProgramAddressSync(
//       [
//           serialNum.toArrayLike(Buffer, "le", 8),
//           tokenMint.toBuffer(),
...
//   // Create new auction PDA for buyer's resale
//   const [newAuction] = PublicKey.findProgramAddressSync(
//       [
//           serialNum.toArrayLike(Buffer, "le", 8),
//           buyer.publicKey.toBuffer(),
...
//               maker: buyer.publicKey,
//               tokenMint: tokenMint,
//               originalAuction: originalAuction, // Original auction for validation
//               makerTokenAccount: buyerTokenAccountItem,
//               auction: newAuction,
//               vault: newVault,
//               systemProgram: SystemProgram.programId,
